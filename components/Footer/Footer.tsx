...
export default function Footer (){
    return(
        ...
        <div className="space-y-7 pr-28 pb-36  " >
           ...
           <img src="" alt="" />
            <a href="https://www.facebook.com/" target="_blank"><img src="/images/fb-icon2.png" alt="" /></a>
            <a href="https://www.youtube.com/" target="_blank"><img src="/images/youtube-icon1.png" alt="" /></a>
            <a href="https://www.instagram.com/" target="_blank"><img src="/images/insta-icon.png" alt="" /></a>
